...
import { Mic, ChevronRight, FileText, Play, Grid, Home, Newspaper, Archive, User } from "lucide-react";
...
export function VoiceHome() {
  ...
  const modeDotColor =
    ctx.mode === "break" ? "#4ade80" :
    ctx.mode === "on-shift" ? "#25467F" : "#a78bfa";
  ...
  const stateHintColor =
    orbState === "listening" ? "#4fc3f7" : "rgba(37,70,127,0.4)";

  return (
    <div className="flex flex-col h-screen overflow-hidden" style={{ background: "#E1ECFF" }}>
      ...
      <div
        ...
        style={{
          background: "rgba(225,236,255,0.82)",
        ...
        <div className="flex items-center justify-between px-5 pt-12 pb-5">
          <div>
            <h1
              ...
              style={{ fontFamily: "Unbounded, sans-serif", color: "#1a3260" }}
            >
              BlueCore
            </h1>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <div className="flex flex-col gap-[4px]">
                <div className="w-3 h-px rounded-full" style={{ background: "rgba(37,70,127,0.5)" }} />
                <div className="w-3 h-px rounded-full" style={{ background: "rgba(37,70,127,0.5)" }} />
                <div className="w-2 h-px rounded-full" style={{ background: "rgba(37,70,127,0.5)" }} />
              </div>
            </button>
            <button
              onClick={() => navigate("/you")}
              className="w-9 h-9 rounded-full overflow-hidden"
              style={{ border: "2px solid rgba(37,70,127,0.2)" }}
            >
      ...
      >
        ...
        <div
          ...
          style={{ background: "linear-gradient(to bottom, rgba(225,236,255,0.5), transparent)" }}
        />
              ...
              >
                <div
                  ...
                  style={
                    msg.role === "user"
                      ? {
                          background: "rgba(37,70,127,0.1)",
                          border: "1px solid rgba(37,70,127,0.14)",
                          color: "#1a3260",
                      ...
                      : {
                          ...
                          backdropFilter: "blur(16px)",
                          border: "1px solid rgba(37,70,127,0.1)",
                          color: "#25467F",
                          borderRadius: "16px 16px 16px 4px",
                          boxShadow: "0 2px 12px rgba(37,70,127,0.06)",
                        }
                  }
                >
                  {msg.text}
                ...
                >
                  {[0, 0.22, 0.44].map((delay, i) => (
                    <motion.div
                      ...
                      style={{ background: "rgba(37,70,127,0.4)" }}
        ...
        <div
          ...
          style={{ background: "linear-gradient(to top, rgba(225,236,255,0.9), transparent)" }}
        />
      </div>
      ...
      <div
        ...
        style={{
          ...
          borderTop: "1px solid rgba(37,70,127,0.08)",
        }}
      >
        {/* Orb + state hint */}
          ...
          >
            <button onClick={handleMicToggle} className="focus:outline-none relative">
              ...
              <div
                ...
                style={{
                  background: "radial-gradient(circle, rgba(37,70,127,0.1) 30%, transparent 70%)",
                  filter: "blur(14px)",
                  transform: "scale(1.3)",
                }}
              />
                  ...
                  <>
                    {[1, 2].map((r) => (
                      <motion.div
                        key={r}
                        className="absolute inset-0 rounded-full pointer-events-none"
                        style={{ border: "1px solid rgba(79,195,247,0.35)" }}
          ...
          <div className="flex items-center gap-3">
              ...
              {!showInput && (
                ...
                >
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <rect x="1" y="3" width="14" height="2" rx="1" fill="rgba(37,70,127,0.45)" />
                    <rect x="1" y="7" width="10" height="2" rx="1" fill="rgba(37,70,127,0.28)" />
                    <rect x="1" y="11" width="12" height="2" rx="1" fill="rgba(37,70,127,0.28)" />
                  </svg>
                </motion.button>
              )}
            </AnimatePresence>
            ...
            <motion.button
              ...
              style={{
                ...
                background: isListening ? "rgba(79,195,247,0.15)" : "rgba(37,70,127,0.1)",
                border: isListening ? "1px solid rgba(79,195,247,0.4)" : "1px solid rgba(37,70,127,0.18)",
                boxShadow: isListening ? "0 0 28px rgba(79,195,247,0.2)" : "0 0 20px rgba(37,70,127,0.08)",
            ...
            >
              <Mic
                ...
                style={{ color: isListening ? "#4fc3f7" : "rgba(37,70,127,0.6)" }}
                fill={isListening ? "rgba(79,195,247,0.25)" : "none"}
              />
              {isListening && (
                <motion.div
        ...
        >
          <div className="flex items-center justify-around">
            {[
              ...
              { path: "/connect", icon: Newspaper, label: "Connect" },
              ...
              return (
                ...
                >
                  <motion.div whileTap={{ scale: 0.88 }}>
                    <item.icon
                      size={20}
                      style={{ color: isActive ? "#4fc3f7" : "rgba(255,255,255,0.25)" }}
                    />
                  </motion.div>
                  <span

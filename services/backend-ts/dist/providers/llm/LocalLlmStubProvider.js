...
exports.LocalLlmStubProvider = void 0;
const env_1 = require("../../config/env");
class LocalLlmStubProvider {
    async getHealth() {
        const url = `${env_1.env.LLM_BASE_URL}${env_1.env.LLM_HEALTH_PATH}`;
        try {
    ...
    async generateReply(input) {
        ...
        const response = await fetch(`${env_1.env.LLM_BASE_URL}/api/chat`, {
            method: "POST",
            headers: {
...
exports.LocalLlmStubProvider = LocalLlmStubProvider;
